    ...
    return (
      <div className="max-w-2xl mx-auto p-4 md:p-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center mb-3">
          <div className="text-xs text-blue-600 font-semibold uppercase tracking-wider mb-1">Total Time</div>
          <div className="text-2xl md:text-3xl font-mono font-bold text-blue-800">
            {formatTime(totalTime, 3)} <span className="text-lg font-normal text-gray-500">({activeLaps.length} laps)</span>
          </div>
          <div className="text-xs text-gray-400 mt-1">
            {excludeLastLap && laps.length > 1 ? 'Final lap excluded (cool-down)' : 'All laps included'}
          </div>
        </div>
