                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-bikotic-blue focus:outline-none text-lg"
                    />
            ...
            <div id="breakdown" className="bg-white border-2 border-gray-200 rounded-lg p-6 shadow-sm hidden">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="border-t-2 border-gray-200 pt-2 mt-2 flex justify-between items-center">
                  ...
                  <span className="font-bold text-bikotic-blue text-lg" id="power-total">-- W</span>
                </div>
              </div>
            </div>
