        ...
        <section className="bg-white border-2 border-gray-200 rounded-xl mb-12 shadow-sm overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center">
              ...
              <a href="/compare" className="inline-block bg-bikotic-blue text-white border-none px-8 py-4 text-lg font-bold rounded-lg cursor-pointer hover:bg-bikotic-blue-dark transition-colors shadow-md text-center">
