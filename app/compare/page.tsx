  ...
  return (
    <main className="min-h-screen p-4 md:p-8 font-sans">
      <div className="max-w-3xl mx-auto">
        ...
        {bike && (
          <>
            <p className="mt-3 text-sm text-gray-500">{bike.total.toLocaleString()} bikes in the database</p>
            ...
            <div className="mt-4 bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{bike.weight ? `${bike.weight} kg` : '—'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{bike.reach ? `${bike.reach} mm` : '—'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Stack</p>
                  <p className="text-lg font-bold">{bike.stack ? `${bike.stack} mm` : '—'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Wheelbase</p>
                  <p className="text-lg font-bold">{bike.wheelbase ? `${bike.wheelbase} mm` : '—'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Head Angle</p>
                  <p className="text-lg font-bold">{bike.head_angle ? `${bike.head_angle}°` : '—'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Chainstay</p>
                  <p className="text-lg font-bold">{bike.chainstay ? `${bike.chainstay} mm` : '—'}</p>
                </div>
              </div>
            </div>
          </>
